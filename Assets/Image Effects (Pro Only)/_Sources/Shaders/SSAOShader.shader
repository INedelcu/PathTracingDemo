...
#if !defined(UNITY_COMPILER_CG) || defined(SHADER_API_PSSL)
...
v2f vert (appdata_img v)
{
    v2f o;
    o.pos = UnityObjectToClipPos (v.vertex);
    o.uv[0] = UnityStereoTransformScreenSpaceTex(MultiplyUV (UNITY_MATRIX_TEXTURE0, v.texcoord));
    o.uv[1] = UnityStereoTransformScreenSpaceTex(MultiplyUV (UNITY_MATRIX_TEXTURE1, v.texcoord));
    return o;
}
